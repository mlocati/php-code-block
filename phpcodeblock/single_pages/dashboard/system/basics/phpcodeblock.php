    ...
    <fieldset>
        <div class="clearfix ccm-pane-body">
            ...
            <div class="form-group">
                ...
                <div class="input">
                    <?php echo $form->select('themeace', ['chrome' => 'chrome', 'clouds' => 'clouds', 'crimson_editor' => 'crimson_editor', 'dawn' => 'dawn', 'dreamweaver' => 'dreamweaver', 'eclipse' => 'eclipse', 'xcode' => 'xcode', 'github' => 'github', 'solarized_light' => 'solarized_light', 'textmate' => 'textmate', 'tomorrow' => 'tomorrow', 'clouds_midnight' => 'clouds_midnight', 'cobalt' => 'cobalt', 'idle_fingers' => 'idle_fingers', 'kr_theme' => 'kr_theme', 'merbivore' => 'merbivore', 'merbivore_soft' => 'merbivore_soft', 'mono_industrial' => 'mono_industrial', 'monokai' => 'monokai', 'pastel_on_dark' => 'pastel_on_dark', 'solarized_dark' => 'solarized_dark', 'terminal' => 'terminal', 'tomorrow_night' => 'tomorrow_night', 'tomorrow_night_blue' => 'tomorrow_night_blue', 'tomorrow_night_bright' => 'tomorrow_night_bright', 'tomorrow_night_eighties' => 'tomorrow_night_eighties', 'twilight' => 'twilight', 'vibrant_ink' => 'vibrant_ink'], $themeace, ['style' => 'width: auto; margin-left: 20px']); ?>
                </div>
            </div>
        </div>
    </fieldset>
